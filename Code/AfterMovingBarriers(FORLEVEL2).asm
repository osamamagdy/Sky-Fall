...
MAIN PROC FAR
	                        ...
	                        INT                 10H
									...
									;CH = hour CL = minute DH = second DL = 1/100 seconds
											...
											JE BARRIER_1_REACH_Top
											JNE BARRIERS_1_2_DONT_REACH_TOP ;Move the 2 barriers to their initial y
										BARRIER_1_REACH_Top:
											 ADD Y_BARRIER1_Last_value,100
											 ADD Y_BARRIER2_Last_value,100
											 JMP check_x 
   BARRIERS_1_2_DONT_REACH_TOP: ;;moving barriers up
											SUB Y_BARRIER1_Last_value,1
				                            SUB Y_BARRIER2_Last_value,1
											

    check_x:
	     CMP X_BARRIER1_Last_value,210
		  JE X_REACH_MAX 
		  JNE X_DONT_REACH_MAX                  
	...
	X_DONT_REACH_MAX:
	ADD X_BARRIER1_Last_value,10
	SUB X_BARRIER2_Last_value,10	
